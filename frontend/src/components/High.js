...
function High() {
  ...
  return (
    <div className='border border-2 p- border-success rounded-4 todosStyles highStyles bg-dark    '>
        ...
        <h1 className='text-white bg-secondary bg-opacity-50 rounded-4 p-2 text-center mb-5'> High Priority Tasks</h1>
        <div className="m-0 p-0 row  ">
          ...
          <div className="incomplete m-3 p-3 col-sm-5 row  rounded-4 mx-auto  ">
              ...
              <h2 className='text-center bg-danger  bg-opacity-50 border p-1 rounded-4 m-1 mb-4 ' >Incomplete Tasks</h2>
                {
                  tasks?.map((obj)=>
                      obj.taskStatus==="incomplete"&&obj.taskPriority==='High'&&
          ...
          <div className="incomplete m-3 p-3 col-sm-5 row  rounded-4 mx-auto  ">
            ...
            <table className='table col-sm-11 rounded-4 text-white  '>
                <h2 className='text-center bg-danger  bg-opacity-50 border p-1 rounded-4 m-1 mb-4 ' >Completed Tasks</h2>
                {
                  tasks?.map((obj)=>
                      obj.taskStatus==="completed"&&obj.taskPriority==='High'&&
                      (<tr className='row m-1 my-2 p-1 border border-1 rounded-4  bg-opacity-50 '  key={obj.id}>
                        <td className="col-sm-1 text-end  ">
